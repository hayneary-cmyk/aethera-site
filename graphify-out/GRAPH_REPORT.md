...
- [[_COMMUNITY_Réseaux lents et Trame|Réseaux lents et Trame]]
...
- `Systèmes de Stabilisation` --evolve_into--> `Réseaux lents`  [EXTRACTED]
...
### Community 1 - "Réseaux lents et Trame"
Cohesion: 0.40
Nodes (6): Côtes Australes, La Trame vivante, Liya, Non-Traduite, Réseaux lents, +4 °C stabilized climate, Monde remplacé

### Community 2 - "Human Settlements"
Cohesion: 0.33
Nodes (6): Feux longs, Les Hauts, Les Laisses, Pierre poussée, 60 million humans, Les Terrasses

### Community 3 - "Deep Chronology"
Cohesion: 0.50
Nodes (4): L’Étale, La Montée, Systèmes de Stabilisation, Le Versement
...
- **Why does `An 3000` connect `AETHERA Setting` to `Réseaux lents et Trame`, `Human Settlements`, `Deep Chronology`, `Drowned Ruins`?**
...
- **Why does `Villes-récifs` connect `Drowned Ruins` to `AETHERA Setting`, `Réseaux lents et Trame`, `Human Settlements`?**
